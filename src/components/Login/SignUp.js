...
const SignUp = () => {
  ...
  const [showImage, setShowImage] = useState(loginImage);
          ...
          if (data === "") {
            ...
            dispatch(
              uiAction.showNotification({
                ...
                status: "error",
                message: "Please Sign In with Registered Email Id",
              })
            );
          }
        });
  ...
  return (
    <Modal onClose={onClose}>
      ...
      <div className={classes.signUp}>
        <img src={showImage} alt="img" className={classes.image} />
        ...
        <form>
          ...
          <div className={classes["input-file"]}>
            <label htmlFor="file">Select Your Image Here</label>
            <input
              type="file"
              id="file"
              name="file"
              className={classes.selectImage}
              onChange={showUpdatedImage}
